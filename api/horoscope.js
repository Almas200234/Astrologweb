// Local backup predictions for each zodiac sign
...
/**
 * Fetch horoscope for a given zodiac sign.
 * If API fails, shows a random local prediction instead.
 */
async function getHoroscope(zodiac) {
  ...
  try {
    ...
    console.warn(`API failed for ${zodiac}, using local prediction:`, error.message);
...
// Example usage: call this function from buttons or dropdown in your HTML
// getHoroscope("cancer");
